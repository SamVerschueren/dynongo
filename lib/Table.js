...
var InsertItem = require('./methods/InsertItem');
var UpdateItem = require('./methods/UpdateItem');
var DeleteItem = require('./methods/DeleteItem');
var DeleteTable = require('./methods/DeleteTable');
var CreateTable = require('./methods/CreateTable');
...
Table.prototype.insert = function (key, data) {
	...
	var put = new InsertItem(this._name, this._dynamodb);
...
Table.prototype.drop = function () {
	...
	return new DeleteTable(this._name, this._dynamodb);
};
...
Table.prototype.create = function (schema) {
	...
	return new CreateTable(this._name, this._dynamodb)._initialize(schema);
};
