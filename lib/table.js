...
const InsertItem = require('./methods/insert-item');
const UpdateItem = require('./methods/update-item');
const DeleteItem = require('./methods/delete-item');
...
Table.prototype.find = function (query, indexName) {
	...
	const qry = new Query(this, this._dynamodb);
...
Table.prototype.findOneAndRemove = function (query) {
	...
	const del = new DeleteItem(this, this._dynamodb);
...
Table.prototype.insert = function (key, data) {
	...
	const put = new InsertItem(this, this._dynamodb);
...
Table.prototype.update = function (key, data, options) {
	...
	const update = new UpdateItem(this, this._dynamodb);
